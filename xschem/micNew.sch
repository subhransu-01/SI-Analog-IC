...
N 750 -210 750 -150 {lab=vo}
N 690 -140 710 -140 {lab=#net1}
N 690 -140 690 -70 {lab=#net1}
N 660 -210 660 -160 {lab=mn3}
N 660 -160 660 -100 {lab=mn3}
N 750 -170 870 -170 {lab=vo}
N 350 -100 500 -100 {lab=#net2}
C {vsource.sym} 350 -70 0 0 {name=V1 value="0 AC 1 sin(0 1m 1e3 0 0 0)" savecurrent=false}
...
device=resistor
m=1}
C {vcvs.sym} 750 -120 0 0 {name=E1 value=1000}
C {res.sym} 720 -210 3 0 {name=R2
value=5k
footprint=1206
device=resistor
m=1}
C {vsource.sym} 690 -40 0 0 {name=V2 value=1.5 savecurrent=false}
C {gnd.sym} 690 -10 0 0 {name=l2 lab=GND}
C {gnd.sym} 750 -90 0 0 {name=l4 lab=GND}
...
.end
"}
C {lab_wire.sym} 870 -170 0 0 {name=p3 sig_type=std_logic lab=vo}
