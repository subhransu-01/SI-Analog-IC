...
C {lab_wire.sym} 80 -90 0 0 {name=p4 sig_type=std_logic lab=vd}
C {devices/code.sym} -320 0 0 0 {name=TT_MODELS1
only_toplevel=true
format="tcleval( @value )"
value="
** opencircuitdesign pdks install
...
"
spice_ignore=false}
C {simulator_commands_shown.sym} -420 -210 0 0 {name=COMMANDS1
simulator=ngspice
only_toplevel=false 
value="
* ngspice commands
...
.endc
"}
C {gnd.sym} 50 70 0 0 {name=l2 lab=GND}
C {sky130_fd_pr/nfet_03v3_nvt.sym} -10 -40 0 0 {name=M3
L=0.5
W=1
nf=1 mult=1
model=nfet_03v3_nvt
